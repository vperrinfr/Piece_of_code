  ...
  * @param username => WDS username
  * @param password => WDS password
  *
  ...
  */
  ...
  function main(params) {
    ...
    var wds_username = params.username;
    var wds_password = params.password;

    var authorization = "Basic " + btoa((wds_username + ":" + wds_password));
